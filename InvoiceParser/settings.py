"""
Django settings for InvoiceParser project.
...
SECRET_KEY = '1$$i_2w-#%j6%s9!c=e%%gdf$sgmr&l*dl0rjq2ps79$i36z9^'
...
ROOT_URLCONF = 'InvoiceParser.urls'
...
WSGI_APPLICATION = 'InvoiceParser.wsgi.application'
